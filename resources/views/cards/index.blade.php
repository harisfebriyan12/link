...
@section('content')
<h1 class="text-2xl font-bold mb-6">Daftar Card</h1>

<form method="GET" action="{{ route('cards.index') }}" class="mb-6 max-w-lg mx-auto flex space-x-4">
    <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari judul atau deskripsi..." class="flex-grow border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-500" />
    <button type="submit" class="bg-green-600 text-white px-6 py-3 rounded-lg shadow hover:bg-green-700 transition duration-300">Cari</button>
</form>
