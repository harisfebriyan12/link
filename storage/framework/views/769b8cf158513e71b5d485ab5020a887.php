    ...
    <div class="p-6 md:pt-8" x-show="open || window.innerWidth >= 768">
        <nav class="flex flex-col space-y-2 text-sm font-medium text-gray-700">
            ...
            <a href="<?php echo e(route('admin.home')); ?>"
               ...
               <?php echo e($activeRoute === 'admin.home' ? 'bg-green-100 text-green-800 font-semibold shadow-sm' : 'hover:bg-green-50 hover:text-green-700'); ?>">
            ...
            <a href="<?php echo e(route('cards.index')); ?>"
               class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200
               <?php echo e($activeRoute === 'cards.index' ? 'bg-green-100 text-green-800 font-semibold shadow-sm' : 'hover:bg-green-50 hover:text-green-700'); ?>">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <span class="truncate">Kelola Link</span>
            </a>
        </nav>
    </div>
</aside>
<?php /**PATH C:\xampp\htdocs\portalWebn\resources\views/admin/partials/sidebar.blade.php ENDPATH**/ ?>